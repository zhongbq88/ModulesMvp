 ...
 * @author mrsimple
 */
public class AsyncEventHandler implements com.zbq.library.event.handler.EventHandler {
     ...
     * 事件处理器
     */
    com.zbq.library.event.handler.EventHandler mEventHandler = new DefaultEventHandler();
